RECIPES_PATH = "./streamlit/data/combined_foodcom.csv"
PARSED_PATH = "./streamlit/data/df_parsed.csv"
PICKLE_FULL_PATH = "./streamlit/data/full_recipes.pkl"

TFIDF_ENCODING_PATH = "./streamlit/models/tfidf_encodings.pkl"
